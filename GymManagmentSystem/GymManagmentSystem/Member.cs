...
namespace GymManagmentSystem
{
    public partial class Member : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cnn = new SqlCommand("insert into Memberr values(@id,@name,@age,@phone,@address,@membershippakage)", con);
            ...
            cnn.Parameters.AddWithValue("@MembershipPakage", textBox3.Text);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cnn = new SqlCommand("insert into Memberr values(@id,@name,@age,@phone,@address,@membershipakage)", con);
        ...
        private void Member_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand cnn = new SqlCommand("Select * from Memberr", con);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cnn = new SqlCommand("delete Memberr where id=@id", con);
